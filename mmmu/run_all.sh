...
python run_llava.py --output_path example_outputs/llava-v1.5-7b-lora-task-others-val.json --model_path /ppio_net0/code/LLaVA/continual-ckpt/domain/llava-v1.5-7b-lora-task-others-merged --config_path configs/llava1.5.yaml
